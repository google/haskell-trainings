...
\begin{frame}
  ...
  \item Source
    ...
    \item
      \href{https://github.com/google/haskell-trainings/releases/download/v1.0/haskell_102_codelab.zip}
      {https://github.com/google/haskell-trainings/releases/download/v1.0/haskell\_102\_codelab.zip}
    \end{itemize}
  \end{itemize}
\end{frame}
